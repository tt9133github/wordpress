...
<script type="text/template" id="ea-bootstrap-main">
    <div class="ea-bootstrap" style="max-width: <%= settings.width %>;">
	  <style>.ui-datepicker{width:100%}</style>
        <form class="form-horizontal">
            ...
            <div class="col-md-6" style="padding-top: 25px;">
                ...
                <div class="step form-group">
                    <div class="block"></div>
                    <label class="ea-label col-sm-2 control-label">
                ...
                <div class="step form-group calendar" class="filter">
                    <div class="block"></div>
					 <label class="ea-label col-sm-2 control-label">预约时间</label>
					  <div class="col-sm-8">
					  		<div class="date"></div>
					</div>
                </div>
            ...
            <div class="step final col-md-6">
                ...
                <div class="step final">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label"><%= _.escape(item.label) %> <% if (item.required == "1") { %>*<% }
                            %> : </label>
                        <div class="col-sm-8">
                            <!-- INPUT TYPE -->
                            <% if(item.type === 'INPUT') { %>
                    ...
                    <% });%>
                    <h3 id="booking-overview-header">预约详情</h3>
                    ...
                    <div class="form-group" style="margin-top:30px;">
                        <div class="col-sm-12 ea-actions-group" style="display: inline-flex; align-items: left; justify-content: left;">
                            <?php echo apply_filters('ea_checkout_button', '<button class="ea-btn ea-submit btn btn-primary btn-lg">确定预约</button>'); ?>
                            &nbsp;&nbsp;<button class="ea-btn ea-cancel btn btn-default btn-lg">取消</button>
                        </div>
                    </div>
                </div>
                <% if (settings.layout_cols === '2') { %>
